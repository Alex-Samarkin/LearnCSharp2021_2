...
namespace Tut5
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            ///
            /// таким образом, нужны быстрые (то есть типизированные) структуры, но они (в общем)
            /// делают такие вещи, которые не связаны с данными внутри типа,
            /// структур много и встраивать их в язык ВСЕ и для ВСЕХ типов - бессмысленно
            /// 
